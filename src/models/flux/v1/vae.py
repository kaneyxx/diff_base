"""FLUX.1 VAE implementation.

FLUX.1 uses a VAE with:
- 16 latent channels
- Flux-specific scaling (0.3611) and shift (0.1159) factors
"""
...
class Flux1VAE(nn.Module):
    """FLUX.1 VAE with 16 latent channels and Flux-specific scaling."""

    def __init__(self, config: DictConfig):
        """Initialize FLUX.1 VAE.
        ...
        latent_channels = config.get("latent_channels", 16)  # FLUX.1 uses 16 channels
