...
test -f ${DATA_ROOT}/dataset/training_splits/CD45_train.json || {
  echo "ERROR: ORION CD45 split missing"; exit 1; }
test -e ${MODEL_HUB_ROOT}/hub/models--black-forest-labs--FLUX.1-Kontext-dev/snapshots/24e9dedc4ef646698dc8eb4e18ae2cec3c9fea0d || {
